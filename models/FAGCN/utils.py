...
def preprocess_data(dataset, train_ratio):
    ...
    if dataset in ['cora', 'citeseer', 'pubmed']:
        ...
        graph_adjacency_list_file_path = '/home/xingtong/WebKB_node_origin/data/{}/raw/out1_graph_edges.txt'.format(dataset)
        graph_node_features_and_labels_file_path = '/home/xingtong/WebKB_node_origin/data/{}/raw/out1_node_feature_label.txt'.format(dataset)
    ...
    # datasets in Geom-GCN
        ...
        a = (torch.tensor(edge_index.tolist()[0]), torch.tensor(edge_index.tolist()[1]))
        g = DGLGraph(a)
        g = dgl.to_simple(g)
        g = dgl.to_bidirected(g)
        g = dgl.remove_self_loop(g)
