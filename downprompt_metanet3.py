...
class downprompt(nn.Module):
    ...
    def forward(self, train=0, neighbors=None, neighbors_2hop=None, idx=None,test_embeds=None):
        ...
        # center = self.embeds.unsqueeze(0)[0,idx]
        ...
        return ret
    def forward_homo_graph(self, train=0, neighbors=None, neighbors_2hop=None, idx=None,test_embeds=None,train_embeds = None,graph_len=None):
        # Model final
